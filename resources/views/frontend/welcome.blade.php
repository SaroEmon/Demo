...
{{--                <li><a class="nav-link scrollto" href="#services">Services</a></li>--}}
                ...
                @auth('user')
                <li><a class="nav-link scrollto" href="{{route('user.profile')}}">User Profile</a></li>
                @endauth
            ...
            <div class="row">
                <div class="col-lg-3">
                    <ul class="nav nav-tabs flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="tab" href="#tab-3">Physiology</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="tab" href="#tab-4">Pathology</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="tab" href="#tab-5">Eye Care</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="tab" href="#tab-5">Surgery</a>
                        </li>
                    </ul>
                </div>
    ...
    <div class="container d-md-flex py-4">
        ...
        <div class="me-md-auto text-center text-md-start">
            ...
            <div class="credits">
                ...
                Designed by <a href="#">Saroar Hossain</a>
            </div>
        </div>
