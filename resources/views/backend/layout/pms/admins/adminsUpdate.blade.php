        ...
        <article class="card-body mx-auto" style="max-width: 400px;">
            ...
            <form action="{{route('admin.update',$admin->id)}}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group input-group">
                    ...
                    <input value="{{$admin->adminContact}}" name="contact" class="form-control" placeholder="Phone number" type="text">
                </div> <!-- form-group// -->
                ...
                <div class="form-group input-group">
                    ...
                    <input value="{{$admin->adminAddress}}" name="address" class="form-control" placeholder="Address" type="text">
                </div>
