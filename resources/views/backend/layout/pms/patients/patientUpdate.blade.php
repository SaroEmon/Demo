            ...
            <form action="{{route('patients.list')}}" method="post">
                ...
                <div class="form-group input-group">
                    ...
                    <select name="department" class="form-control">
                        ...
                        <option @if ($patients->department) selected @endif value="medicine">Medicine</option>
                        <option @if ($patients->department) selected @endif value="physiology"> Physiology</option>
                        <option @if ($patients->department) selected @endif value="ophthalmology"> Ophthalmology</option>
                        <option @if ($patients->department) selected @endif value="microbiology"> Microbiology</option>
                        <option @if ($patients->department) selected @endif value="pathology"> Pathology </option>
                        <option @if ($patients->department) selected @endif value="pharmacology"> Pharmacology</option>
                        <option @if ($patients->department) selected @endif value="community medicine"> Community Medicine</option>
                        <option @if ($patients->department) selected @endif value="surgery"> Surgery </option>
